...
public:
    ...
    Position screenPositionFromCursor(Position cursor) const;

    Cursor cursorFromScreenPosition(Position screenPosition) const;
    Position localFromScreenPosition(Position pos) const;
